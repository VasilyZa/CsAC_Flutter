...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  IconData settingsCategoryIcon(_SettingsCategory category) {
    return switch (category) {
      _SettingsCategory.account => CupertinoIcons.person_crop_circle,
      _SettingsCategory.appearance => CupertinoIcons.paintbrush,
      _SettingsCategory.data => CupertinoIcons.speedometer,
      _SettingsCategory.security => CupertinoIcons.lock,
      _SettingsCategory.about => CupertinoIcons.info_circle,
      _SettingsCategory.developer => CupertinoIcons.hammer,
    };
  }
